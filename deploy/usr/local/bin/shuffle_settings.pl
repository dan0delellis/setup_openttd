...
my ($opts_file, $conf_path, $template, $target_file) = @paths;
my ($cli_user,$cli_opts_file, $cli_conf_path, $cli_template, $cli_target_file,$cli_defaults);
...
if (defined $cli_user) {
    ...
    ($opts_file, $conf_path, $template, $target_file) = @paths;
